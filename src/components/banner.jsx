...
export default function Banner(){   
    ...
    return(
        <>
        <main className='banner h-screen flex flex-col justify-center items-center gap-3'>
            <title>Sail Bacalar – Discover Bacalar Lagoon on a Catamaran</title>
            <img className='max-h-50 z-10 h1-animate' src="/images/logo.png" alt="sail bacalar logo" />
            <h1 className='h1 text-5xl p-2 banner-content z-10 text-center'>Sail - Enjoy - Get Inspired</h1>
