...
export default function Tours() {
    ...
    return(
        ...
        <main className='mt-5 mb-10 mx-10 text-center'>
            <section className='sail lg:m-10 mb-5 rounded bg-neutral-300/20 flex flex-col md:font-normal gap-2 items-center justify-center rounded xl:flex-row px-10'>
                ...
                <ul className='mb-5'>
                    ...
                    <li className='mt-3'>
                        <div className='flex gap-3 items-center'>
                            ...
                            <div className='text-left'>
                                <h4>{t('labels.pricesLabel')}</h4>
                                <p>$7'000 MXN {t('labels.basePrice')}, $1'000 MXN {t('labels.extraPerson')}</p>
                            </div>
                        </div>
                    </li>
                    </ul>
